 ...
 */
public class HdfsBasedLockProvider implements LockProvider<String>, Serializable {

  private static final Logger LOG = LogManager.getLogger(HdfsBasedLockProvider.class);
  ...
  public HdfsBasedLockProvider(final LockConfiguration lockConfiguration, final Configuration configuration) {
  ...
  public boolean tryLock(long time, TimeUnit unit) {
    try {
      synchronized (LOCK_FILE_NAME) {
        ...
        acquireLock();
        dataOutputStream = fs.append(this.lockFile);
        return true;
      }
