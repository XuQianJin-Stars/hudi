...
public interface MultiplePartialUpdateHelper {
  ...
  default boolean needUseOldRecordToUpdate(GenericRecord incomingRecord, GenericRecord currentRecord, MultiplePartialUpdateUnit.PartialUpdateUnit partialUpdateUnit) {
    ...
    Comparable currentOrderingVal = (Comparable) HoodieAvroUtils.getNestedFieldVal(currentRecord, orderingField, true, false);
    Comparable incomingOrderingVal = (Comparable) HoodieAvroUtils.getNestedFieldVal(incomingRecord, orderingField, true, false);
